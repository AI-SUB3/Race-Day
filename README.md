...
- **成績分享圖**：方形／限時動態兩種版面，可勾選心率、戰靴、補給、GPX 軌跡與 QR code，附一鍵複製的 IG 文案，手機直接進系統分享面板
